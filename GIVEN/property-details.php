    ...
    <div class="container">
        <div class="m-property-info mb-4 d-xl-none">
            ...
            <div class="card-stack">
                <div class="offer-box">
                    <strong class="text-center d-block">APRIL SPECIAL</strong>
        ...
        <div class="row">
            ...
            <div class="col col-xl page-detail-column">
            ...
            <aside class="col-12 col-xl-auto sidebar-column">
                <div class="sidebar-outer">
                    ...
                    <p>Or speak to a travel advisor on the phone:</p>
                    <a href="tel:+91 98100 74777" class="btn d-block border border-secondary border-1 btn-outline-secondary rounded-pill d-flex align-items-center justify-content-center">
